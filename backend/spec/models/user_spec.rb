...
RSpec.describe User, type: :model do
  describe 'Save data' do
    ...
    it 'should not save duplicated githubs id' do
      usuario1 = User.create(github_id: 12345, login: "usuario 1", url: "url.com", name: "User 1")
      usuario = User.new(github_id: 12345, login: "prueba", url: "prueba.com", name: "Nombre")
